...
func TestGCSObject_ExtractKindName(t *testing.T) {
	{
		o := GCSObject{
			ID: "agtzfnN0Zy1jaGFvc3JACxIcX0FFX0RhdGFzdG9yZUFkbWluX09wZXJhdGlvbhjx52oMCxIWX0FFX0JhY2t1cF9JbmZvcm1hdGlvbhgBDA.Article.backup_info",
		}
	...
	{
		o := GCSObject{
			ID: "2017-11-14T06:47:01_23208/all_namespaces/kind_Item/all_namespaces_kind_Item.export_metadata",
		}
		kind := o.ExtractKindName()
